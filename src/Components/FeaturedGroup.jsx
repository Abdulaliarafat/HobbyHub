...
import { Link } from 'react-router';
     const featuredDataPromise = fetch('https://y-flame-eight-20.vercel.app/group/latest').then(res => res.json())

const FeaturedGroup = () => {

const featuredData = use(featuredDataPromise)

    return (
        <div className='max-w-5xl mx-auto my-5  '>
            <h1 className='text-3xl font-bold text-center mb-4'>Featured groups</h1>
            <p className='dark:text-white mb-10 text-center font-medium text-md text-gray-600 text-balance mt-2 '>Hobbies are fun activities we enjoy in our free time, like reading, painting, or gardening.</p>
