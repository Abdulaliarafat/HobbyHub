...
const Connection = () => {
    ...
    return (
        <div className='max-w-5xl mx-auto my-20'>
            <h1 className='font-bold text-3xl text-center mb-5'>Understanding Collaboration</h1>
            <p className='mb-10 font-medium text-gray-500 dark:text-white text-center text-balance'>Collaboration means sharing ideas, respecting others, and working together efficiently.</p>
